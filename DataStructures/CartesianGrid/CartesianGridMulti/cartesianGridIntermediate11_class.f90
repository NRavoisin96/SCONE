module cartesianGridIntermediate11_class
  ...
  use cartesianCellIntermediate11_class,        only : cartesianCellIntermediate11
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate11
    private
    type(cartesianCellIntermediate11), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate11
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate11), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate11), intent(in)        :: self
...
end module cartesianGridIntermediate11_class
