module cartesianGridIntermediate6_class
  ...
  use cartesianCellIntermediate6_class,        only : cartesianCellIntermediate6
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate6
    private
    type(cartesianCellIntermediate6), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate6
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate6), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate6), intent(in)        :: self
...
end module cartesianGridIntermediate6_class
