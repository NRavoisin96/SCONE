module cartesianCellIntermediate7_class
  ...
  use cartesianGridIntermediate8_class,only : cartesianGridIntermediate8
  ...
  !!
  !!
  type, public                                          :: cartesianCellIntermediate7
    private
  ...
  end type cartesianCellIntermediate7
...
contains
  ...
  subroutine cellTestPolyhedronInclusion(self, faces, currElementFaceIdxs, centroid, &
    ...
    class(cartesianCellIntermediate7), intent(inout)     :: self
  ...
  subroutine refineCell(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    if (self % chi == 0) then
      ...
      if (n_layers > currLayer+1) then 
        allocate(cartesianGridIntermediate8:: self % subGrid)
      else
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianCellIntermediate7), intent(in)        :: self
...
end module cartesianCellIntermediate7_class