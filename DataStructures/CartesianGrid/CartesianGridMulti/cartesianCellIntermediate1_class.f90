module cartesianCellIntermediate1_class
  ...
  !!
  !!
  type, public                                          :: cartesianCellIntermediate1
    private
  ...
  end type cartesianCellIntermediate1
...
end module cartesianCellIntermediate1_class