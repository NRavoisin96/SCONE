module cartesianGridIntermediate7_class
  ...
  use cartesianCellIntermediate7_class,        only : cartesianCellIntermediate7
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate7
    private
    type(cartesianCellIntermediate7), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate7
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate7), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate7), intent(in)        :: self
...
end module cartesianGridIntermediate7_class
