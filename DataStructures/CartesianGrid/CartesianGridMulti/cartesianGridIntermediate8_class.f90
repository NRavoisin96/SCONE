module cartesianGridIntermediate8_class
  ...
  use cartesianCellIntermediate8_class,        only : cartesianCellIntermediate8
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate8
    private
    type(cartesianCellIntermediate8), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate8
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate8), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate8), intent(in)        :: self
...
end module cartesianGridIntermediate8_class
