module cartesianGridIntermediate4_class
  ...
  use cartesianCellIntermediate4_class,        only : cartesianCellIntermediate4
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate4
    private
    type(cartesianCellIntermediate4), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate4
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate4), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate4), intent(in)        :: self
...
end module cartesianGridIntermediate4_class
