module cartesianCellIntermediate6_class
  ...
  use cartesianGridIntermediate7_class,only : cartesianGridIntermediate7
  ...
  !!
  !!
  type, public                                          :: cartesianCellIntermediate6
    private
  ...
  end type cartesianCellIntermediate6
...
contains
  ...
  subroutine cellTestPolyhedronInclusion(self, faces, currElementFaceIdxs, centroid, &
    ...
    class(cartesianCellIntermediate6), intent(inout)     :: self
  ...
  subroutine refineCell(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    if (self % chi == 0) then
      ...
      if (n_layers > currLayer+1) then 
        allocate(cartesianGridIntermediate7:: self % subGrid)
      else
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianCellIntermediate6), intent(in)        :: self
...
end module cartesianCellIntermediate6_class