module cartesianCellIntermediate11_class
  ...
  !!
  !!
  type, public                                          :: cartesianCellIntermediate11
    private
  ...
  end type cartesianCellIntermediate11
...
contains
  ...
  subroutine cellTestPolyhedronInclusion(self, faces, currElementFaceIdxs, centroid, &
    ...
    class(cartesianCellIntermediate11), intent(inout)     :: self
  ...
  subroutine refineCell(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    if (self % chi == 0) then
      ...
      if (n_layers > currLayer+1) then 
        call fatalError("refineCell in cartesianCellIntermediate11_class.f90", &
                        "Maximum possible number of layers is 13. You have gone above this value.")
      else
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianCellIntermediate11), intent(in)        :: self
...
end module cartesianCellIntermediate11_class