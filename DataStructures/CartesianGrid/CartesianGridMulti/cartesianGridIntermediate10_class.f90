module cartesianGridIntermediate10_class
  ...
  use cartesianCellIntermediate10_class,        only : cartesianCellIntermediate10
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate10
    private
    type(cartesianCellIntermediate10), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate10
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate10), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate10), intent(in)        :: self
...
end module cartesianGridIntermediate10_class
