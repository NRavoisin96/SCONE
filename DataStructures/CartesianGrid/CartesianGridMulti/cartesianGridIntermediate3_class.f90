module cartesianGridIntermediate3_class
  ...
  use cartesianCellIntermediate3_class,        only : cartesianCellIntermediate3
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate3
    private
    type(cartesianCellIntermediate3), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate3
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate3), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate3), intent(in)        :: self
...
end module cartesianGridIntermediate3_class
