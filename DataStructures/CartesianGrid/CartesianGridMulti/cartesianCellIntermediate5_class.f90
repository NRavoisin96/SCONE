module cartesianCellIntermediate5_class
  ...
  use cartesianGridIntermediate6_class,only : cartesianGridIntermediate6
  ...
  !!
  !!
  type, public                                          :: cartesianCellIntermediate5
    private
  ...
  end type cartesianCellIntermediate5
...
contains
  ...
  subroutine cellTestPolyhedronInclusion(self, faces, currElementFaceIdxs, centroid, &
    ...
    class(cartesianCellIntermediate5), intent(inout)     :: self
  ...
  subroutine refineCell(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    if (self % chi == 0) then
      ...
      if (n_layers > currLayer+1) then 
        allocate(cartesianGridIntermediate6:: self % subGrid)
      else
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianCellIntermediate5), intent(in)        :: self
...
end module cartesianCellIntermediate5_class