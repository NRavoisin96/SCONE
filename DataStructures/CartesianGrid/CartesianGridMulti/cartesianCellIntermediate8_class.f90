module cartesianCellIntermediate8_class
  ...
  use cartesianGridIntermediate9_class,only : cartesianGridIntermediate9
  ...
  !!
  !!
  type, public                                          :: cartesianCellIntermediate8
    private
  ...
  end type cartesianCellIntermediate8
...
contains
  ...
  subroutine cellTestPolyhedronInclusion(self, faces, currElementFaceIdxs, centroid, &
    ...
    class(cartesianCellIntermediate8), intent(inout)     :: self
  ...
  subroutine refineCell(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    if (self % chi == 0) then
      ...
      if (n_layers > currLayer+1) then 
        allocate(cartesianGridIntermediate9:: self % subGrid)
      else
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianCellIntermediate8), intent(in)        :: self
...
end module cartesianCellIntermediate8_class