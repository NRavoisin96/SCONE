module cartesianGridIntermediate1_class
  ...
  use cartesianCellIntermediate1_class,        only : cartesianCellIntermediate1
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate1
    private
    type(cartesianCellIntermediate1), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate1
      ...
      do j = 1, localNxyz(2)
        do k = 1, localNxyz(3)
          ...
          call self % grid(i,j,k) % refineCell2(vertices, edges, faces, elements, spacing, spacingInv, n_xyz, &
                                               ...
                                               targetDistance, targetDistanceSqr, candFaceIdxs)
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate1), intent(in)        :: self
...
end module cartesianGridIntermediate1_class
