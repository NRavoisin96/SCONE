module cartesianGridIntermediate9_class
  ...
  use cartesianCellIntermediate9_class,        only : cartesianCellIntermediate9
  use numPrecision   
  ...
  !!
  !!
  type, public, extends(cartesianGridSubLayer)                      :: cartesianGridIntermediate9
    private
    type(cartesianCellIntermediate9), dimension(:,:,:), allocatable  :: grid
  ...
  end type cartesianGridIntermediate9
...
contains
  ...
  subroutine init(self, vertices, edges, faces, elements, spacing, spacingInv, n_xyz, n_layers, &
    ...
    class(cartesianGridIntermediate9), intent(inout)     :: self
...
!&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
  ...
  !   class(cartesianGridIntermediate9), intent(in)        :: self
...
end module cartesianGridIntermediate9_class
