...
# ─────────────── CONTROL PANEL ──────────────────────────────────
FACES_VALUES   = [4, 7, 9]    # outer loop
REFINE_VALUES  = [8, 10]                     # inner loop
...
DECK_FILE  = BASE_DIR / "InputFiles" / "SCONE_ToyProblemPoly2"
...
def main() -> None:
    ...
    csv_path = BASE_DIR / f"treeSweepPoly1560_{dt.datetime.now():%Y%m%d_%H%M%S}.csv"
